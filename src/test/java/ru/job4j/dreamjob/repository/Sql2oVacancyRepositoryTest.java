...
class Sql2oVacancyRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var vacancy = sql2oVacancyRepository.save(new Vacancy(0,
                "title", "description", true, 1, creationDate, file.getId()));
    ...
    public void whenSaveSeveralThenGetAll() {
        ...
        var vacancy1 = sql2oVacancyRepository.save(new Vacancy(0, "title1",
                "description1", true, 1, creationDate, file.getId()));
        var vacancy2 = sql2oVacancyRepository.save(new Vacancy(0, "title2",
                "description2", false, 1, creationDate, file.getId()));
        var vacancy3 = sql2oVacancyRepository.save(new Vacancy(0, "title3",
                "description3", true, 1, creationDate, file.getId()));
    ...
    public void whenDeleteThenGetEmptyOptional() {
        ...
        var vacancy = sql2oVacancyRepository.save(new Vacancy(0, "title",
                "description", true, 1, creationDate, file.getId()));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedVacancy = new Vacancy(
                ...
                !vacancy.getVisible(), 1, creationDate.plusDays(1), file.getId()
        );
    ...
    public void whenUpdateUnExistingVacancyThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var vacancy = new Vacancy(0, "title",
                "description", true, 1, creationDate, file.getId());
